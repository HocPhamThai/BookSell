...
namespace BookEcomWeb.DataAccess.Migrations
{
    ...
    [Migration("20250329094054_AddSessonIdInOrderHeader")]
    partial class AddSessonIdInOrderHeader
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookEcomWeb.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookEcomWeb.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookEcomWeb.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookEcomWeb.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookEcomWeb.Models.OrderDetail", b =>
                {
                    b.HasOne("BookEcomWeb.Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("BookEcomWeb.Models.Product", b =>
                {
                    b.HasOne("BookEcomWeb.Models.Category", "Category")
                        .WithMany()
